...
use Yef\Contracts\View\View as IView;
use Yef\Response;
...
class Template implements IView
{
    ...
    {
        $this->file($file, self::$_config['default_format']);
        $this->set($params);
     ...
     * @return Yef\View\Template\Block
     */
     ...
     * @throws Yef\View\Exception\TemplateMissing
     * @return boolean
     */
     ...
     * @return string
     */
    public function getContent($parsePHP = true)
    {
        if (!$this->_templateContent) {
            ...
            if ($this->layout()) {
                ...
                // Get content
                $templateContent = $layout->getContent($parsePHP);
            }
